  ...
  pl: {
    ...
    projects: {
      ...
      descriptions: [
        ...
        "Aplikacja webowa do zarządzania portfelem inwestycyjnym z analizą rynkową i rekomendacjami AI. Moduł AI Advisor z integracją LLM, bezpieczeństwo w oparciu o OAuth2/OIDC (Keycloak) i mikroserwisy.",
  ...
  en: {
    ...
    projects: {
      ...
      descriptions: [
        ...
        "Web application for investment portfolio management with market analysis and AI recommendations. Features an AI Advisor module powered by LLMs, OAuth2/OIDC security with Keycloak, and microservices.",
